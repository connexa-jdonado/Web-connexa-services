        ...
        <div className="container">
          <div className="showcase-grid mirror" style={{ gridTemplateColumns: '3fr 2fr' }}>
            ...
            <div className="showcase-text">
              <h2 className="showcase-name fade-up d1" style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>Workflow Builder <span style={{color:'#172554', fontSize:'0.7em', fontWeight:700}}>
