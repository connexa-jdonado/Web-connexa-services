...
export default function ProductosClient() {
  ...
  return (
    <>
        ...
        <div className="container">
          ...
          <div className="prod-item-header fade-up">
            <div className="prod-item-title-row">
              <h2 className="prod-item-title" style={{ fontFamily: 'var(--font-heading)', fontSize: '48px', fontWeight: 800, color: '#172554', lineHeight: '1.08', letterSpacing: '-0.025em', margin: 0 }}>Workflow Builder <span className="prod-ai-badge" style={{ fontSize: '20px', fontWeight: 700, color: '#99D95E' }}>✦ AI</span></h2>
            </div>
          ...
          <div className="prod-features-grid fade-up d2">
            <div className="prod-feature-card">
              <div className="prod-feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg></div>
            ...
            <div className="prod-feature-card">
              <div className="prod-feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/></svg></div>
            ...
            <div className="prod-feature-card">
              <div className="prod-feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"/></svg></div>
            ...
            <div className="prod-feature-card">
              <div className="prod-feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg></div>
            ...
            <div className="prod-feature-card">
              <div className="prod-feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="7" y="7" width="10" height="10" rx="1"/><path d="M7 12H4"/><path d="M20 12h-3"/><path d="M12 7V4"/><path d="M12 20v-3"/></svg></div>
      ...
      <div className="prod-item" id="prod-fsmtool">
        <div className="container">
          {/* BLOQUE 1: Header */}
          <div className="prod-item-header fade-up">
            <div className="prod-item-title-row">
              <h2 className="prod-item-title" style={{ fontFamily: 'var(--font-heading)', fontSize: '48px', fontWeight: 800, color: '#172554', lineHeight: '1.08', letterSpacing: '-0.025em', margin: 0 }}>FSMTool <span className="prod-ai-badge" style={{ fontSize: '20px', fontWeight: 700, color: '#99D95E' }}>✦ AI</span></h2>
            </div>
            <p className="prod-item-tagline">{tr('Operaciones masivas en OFSC, sin complejidad', 'Bulk OFSC operations, without complexity')}</p>
            <p className="prod-item-desc">{tr('FSMTool es una suite de administración y monitoreo de operaciones construida nativamente sobre Oracle Field Service Cloud. Permite a los equipos de operaciones ejecutar acciones masivas, visualizar el estado en tiempo real y automatizar los procesos del día a día.', 'FSMTool is an operations administration and monitoring suite built natively on Oracle Field Service Cloud. It lets operations teams execute bulk actions, visualize status in real time, and automate day-to-day processes.')}</p>
          </div>
          {/* BLOQUE 2: Imagen full width */}
          <div className="prod-item-visual fade-up d1">
            <div className="browser-frame">
          ...
          <div className="prod-features-grid fade-up d2">
            <div className="prod-feature-card">
              <div className="prod-feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="23 6 13.5 15.5 8.5 10.5 1 18"/></svg></div>
              <div className="prod-feature-title">{tr('Eficiencia operacional ×3', 'Operational efficiency ×3')}</div>
              <div className="prod-feature-desc">{tr('Ejecutá acciones sobre miles de órdenes en segundos.', 'Execute actions on thousands of orders in seconds.')}</div>
            </div>
            <div className="prod-feature-card">
              <div className="prod-feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg></div>
              <div className="prod-feature-title">{tr('Visibilidad en tiempo real', 'Real-time visibility')}</div>
              <div className="prod-feature-desc">{tr('Dashboard operacional con KPIs y alertas automáticas.', 'Operational dashboard with KPIs and automatic alerts.')}</div>
            </div>
            <div className="prod-feature-card">
              <div className="prod-feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg></div>
              <div className="prod-feature-title">{tr('Sin riesgo de errores', 'No risk of errors')}</div>
              <div className="prod-feature-desc">{tr('Validaciones integradas antes de cada acción masiva.', 'Integrated validations before every bulk action.')}</div>
            </div>
            <div className="prod-feature-card">
              <div className="prod-feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 9h18M9 21V9"/></svg></div>
              <div className="prod-feature-title">{tr('Reportería exportable', 'Exportable reporting')}</div>
              <div className="prod-feature-desc">{tr('Exportá cualquier vista a Excel o PDF con un clic.', 'Export any view to Excel or PDF with one click.')}</div>
            </div>
            <div className="prod-feature-card">
              <div className="prod-feature-icon"><svg width="32" height="32" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M3 3v18h18"/><polyline points="7 14 10 10 13 12 17 7"/></svg></div>
              <div className="prod-feature-title">{tr('Dashboard inteligente con IA', 'Intelligent AI dashboard')}</div>
              <div className="prod-feature-desc">{tr('Análisis predictivo impulsado por IA.', 'AI-powered predictive analytics.')}</div>
            </div>
          </div>
          {/* BLOQUE 4: Tags y botones */}
          <div className="prod-item-footer fade-up d3">
