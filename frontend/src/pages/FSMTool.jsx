...
export default function FSMToolClient() {
  ...
  return (
    <>
      <Head>
        <title>FSMTool | Connexa Services</title>
        <meta name="description" content="FSMTool — Suite de operaciones masivas para Oracle Field Service Cloud. Reasignación, gestión de inventario, monitoreo en tiempo real y más, sin complejidad." />
        <meta name="keywords" content="Oracle Field Service, OFSC, FSMTool, Field Service Management, operaciones masivas, implementación OFSC" />
      </Head>
      <style>{`
      ...
      <style>{`
        ...
        @media (min-width: 769px) and (max-height: 760px) {
          .fsm-hero-layout   { padding-top: 84px !important; padding-bottom: 24px !important; }
          .fsm-hero-title    { font-size: 40px !important; margin-bottom: 4px !important; }
          .fsm-hero-subtitle { font-size: 40px !important; margin-bottom: 8px !important; }
          .fsm-hero-stats    { margin-bottom: 24px !important; }
        }
      `}</style>
      {/* ── HERO FULLSCREEN ── */}
      <div style={{ width: '100%', minHeight: '100vh', background: 'linear-gradient(135deg, #0d1b3e 0%, #172554 60%, #1a3a2a 100%)', display: 'flex', alignItems: 'center', position: 'relative', overflow: 'hidden', padding: '0' }}>
        ...
        <div className="fsm-hero-layout" style={{ display: 'flex', width: '100%', maxWidth: '1400px', margin: '0 auto', padding: '104px 60px', alignItems: 'center', gap: '80px', position: 'relative', zIndex: 2 }}>
          {/* Columna izquierda 48% */}
          <div className="fsm-hero-left" style={{ flex: '1 1 45%' }}>
          ...
          {/* Columna derecha 58% */}
          <div className="fsm-hero-right" style={{ flex: '1 1 55%' }}>
